...
const Sparkle = () => (
  <span className="text-terracotta mx-4 md:mx-12 select-none shrink-0">
...
export const CategoryRibbon = () => {
  return (
    <section className="relative h-64 md:h-[40vh] bg-forest-green flex flex-col justify-center overflow-hidden border-y border-white/5">
      ...
      <div className="relative z-10 space-y-8 md:space-y-16">
        {/* Row 1: Leftward Marquee (Uppercase + tracking-widest) */}
          ...
          >
            {[...row1, ...row1, ...row1, ...row1].map((item, index) => (
              <div key={index} className="flex items-center">
                <span className="font-serif text-2xl md:text-4xl text-cream uppercase tracking-[0.2em] hover:tracking-[0.3em] transition-all duration-700 cursor-default px-4">
                  {item}
                </span>
                <Sparkle />
              </div>
        ...
        {/* Row 2: Rightward Marquee (Uppercase Italic + tracking-widest) */}
        <div className="flex overflow-hidden select-none group">
          <motion.div
            initial={{ x: "-50%" }}
            animate={{ x: 0 }}
          ...
          >
            {[...row2, ...row2, ...row2, ...row2].map((item, index) => (
              <div key={index} className="flex items-center">
                <span className="font-serif italic text-2xl md:text-4xl text-cream uppercase tracking-[0.2em] hover:tracking-[0.3em] transition-all duration-700 cursor-default px-4">
                  {item}
                </span>
                <Sparkle />
              </div>
